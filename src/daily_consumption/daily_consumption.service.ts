...
export class DailyConsumptionService
{
  ...
  private lt1Meters = [
    ...
    { energy: 'U3_PLC_Del_ActiveEnergy', power: 'U3_PLC_ActivePower_Total', powerFactor: 'U3_PLC_PowerFactor_Avg', voltage: 'U3_PLC_Voltage_Avg', metername: 'Lab + Main Office', deptname: 'Lab + Offices', MCS: '2', installedLoad: '15' },

    { energy: 'U4_PLC_Del_ActiveEnergy', power: 'U4_PLC_ActivePower_Total', powerFactor: 'U4_PLC_PowerFactor_Avg', voltage: 'U4_PLC_Voltage_Avg', metername: 'Lighting Inside + Outside', deptname: 'Mills Lighting', MCS: '1', installedLoad: '50' },

    {
      energy: 'U5_PLC_Del_ActiveEnergy', power: 'U5_PLC_ActivePower_Total', powerFactor: 'U5_PLC_PowerFactor_Avg', voltage: 'U5_PLC_Voltage_Avg', metername: 'HFO Plant Auxiliary (2nd source)', deptname: 'HFO Plant Aux(2nd Source)', MCS: '1', installedLoad: '203'
    },
    ...
    { energy: 'U14_PLC_Del_ActiveEnergy', power: 'U14_PLC_ActivePower_Total', powerFactor: 'U14_PLC_PowerFactor_Avg', voltage: 'U14_PLC_Voltage_Avg', metername: 'Compressor (119 kW)', deptname: 'Air Compressor', MCS: '3', installedLoad: '132', info: '41kW + 41kW + 50kW' },
    ...
    { energy: 'U17_PLC_Del_ActiveEnergy', power: 'U17_PLC_ActivePower_Total', powerFactor: 'U17_PLC_PowerFactor_Avg', voltage: 'U17_PLC_Voltage_Avg', metername: 'Ring A/C (Supply & Return Fans)', deptname: 'Ring A/C', MCS: '2', installedLoad: '333', info: 'Pumps + Dust Collector + Rotary Air + Rotary Water Filter' },

    {
      energy: 'U18_PLC_Del_ActiveEnergy', power: 'U18_PLC_ActivePower_Total', powerFactor: 'U18_PLC_PowerFactor_Avg', voltage: 'U18_PLC_Voltage_Avg', metername: 'Ring A/C (Supply & Return Fans) Bypass', deptname: 'Ring A/C', MCS: '2', installedLoad: '333', info: 'Pumps + Dust Collector + Rotary Air + Rotary Water Filter'
    },

    { energy: 'U20_PLC_Del_ActiveEnergy', power: 'U20_PLC_ActivePower_Total', powerFactor: 'U20_PLC_PowerFactor_Avg', voltage: 'U20_PLC_Voltage_Avg', metername: 'Compressor (119 kW) Bypass', deptname: 'Air Compressor', MCS: '3', installedLoad: '132', info: '41kW + 41kW + 50kW' },
  ...
  // 🔹 LT2 meters
  private lt2Meters = [
    { energy: 'U1_GW01_Del_ActiveEnergy', power: 'U1_GW01_ActivePower_Total', powerFactor: 'U1_GW01_PowerFactor_Avg', voltage: 'U1_GW01_Voltage_Avg', metername: 'Back Process A/C', deptname: 'Back Process A/C', MCS: '2', installedLoad: '142.2' },

    { energy: 'U2_GW01_Del_ActiveEnergy', power: 'U2_GW01_ActivePower_Total', powerFactor: 'U2_GW01_PowerFactor_Avg', voltage: 'U2_GW01_Voltage_Avg', metername: 'Conditioning Machine', deptname: 'Conditioning Machine', MCS: '1', installedLoad: '80' },
    ...
    { energy: 'U5_GW01_Del_ActiveEnergy', power: 'U5_GW01_ActivePower_Total', powerFactor: 'U5_GW01_PowerFactor_Avg', voltage: 'U5_GW01_Voltage_Avg', metername: 'Card 1-4 + 9-12', deptname: 'Card + Breaker', MCS: '8', installedLoad: '152.0', info: '8*19 kW' },
    ...
    { energy: 'U9_GW01_Del_ActiveEnergy', power: 'U9_GW01_ActivePower_Total', powerFactor: 'U9_GW01_PowerFactor_Avg', voltage: 'U9_GW01_Voltage_Avg', metername: 'Card 5-8 + 13-14 + Breaker 5-6', deptname: 'Card + Breaker', MCS: '8', installedLoad: '132.0', info: '6*19 kW + 2*9 kW' },
    ...
    {
      energy: 'U7_GW01_Del_ActiveEnergy', power: 'U7_GW01_ActivePower_Total', powerFactor: 'U7_GW01_PowerFactor_Avg', voltage: 'U7_GW01_Voltage_Avg', metername: 'Gas plant Auxiliary(2nd source)', deptname: 'Gas Plant Aux (2nd Source)', MCS: '1', installedLoad: '130'
    },

    { energy: 'U14_GW01_Del_ActiveEnergy', power: 'U14_GW01_ActivePower_Total', powerFactor: 'U14_GW01_PowerFactor_Avg', voltage: 'U14_GW01_Voltage_Avg', metername: 'B/Card + Comber Filter', deptname: 'B/Card + Comber Filter', MCS: '2', installedLoad: '203.2' },

    { energy: 'U12_GW01_Del_ActiveEnergy', power: 'U12_GW01_ActivePower_Total', powerFactor: 'U12_GW01_PowerFactor_Avg', voltage: 'U12_GW01_Voltage_Avg', metername: 'B/Card + Comber Filter Bypass', deptname: 'B/Card + Comber Filter', MCS: '2', installedLoad: '203.2' },
    ...
    { energy: 'U19_GW01_Del_ActiveEnergy', power: 'U19_GW01_ActivePower_Total', powerFactor: 'U19_GW01_PowerFactor_Avg', voltage: 'U19_GW01_Voltage_Avg', metername: 'Lab A/C', deptname: 'Lab + Offices', MCS: '2', installedLoad: '8' },
    ...
    { energy: 'U21_GW01_Del_ActiveEnergy', power: 'U21_GW01_ActivePower_Total', powerFactor: 'U21_GW01_PowerFactor_Avg', voltage: 'U21_GW01_Voltage_Avg', metername: 'PF Panel', deptname: 'Spare/PF Panels', MCS: '0', installedLoad: '0' }
  ];
  ...
  private unit5Lt1Meters = [
    ...
    {
      energy: 'U8_GW02_Del_ActiveEnergy', power: 'U8_GW02_ActivePower_Total', powerFactor: 'U8_GW02_PowerFactor_Avg', voltage: 'U8_GW02_Voltage_Avg', metername: 'Ring A/C (Supply Fans)', deptname: 'Ring A/C', MCS: '1', installedLoad: '269.5', info: 'Pumps + Pneumafil fan + Rotary Water filter'
    },

    { energy: 'U9_GW02_Del_ActiveEnergy', power: 'U9_GW02_ActivePower_Total', powerFactor: 'U9_GW02_PowerFactor_Avg', voltage: 'U9_GW02_Voltage_Avg', metername: 'Blow Room', deptname: 'Blow Room', MCS: '2', installedLoad: '166' },
    ...
    {
      energy: 'U15_GW02_Del_ActiveEnergy', power: 'U15_GW02_ActivePower_Total', powerFactor: 'U15_GW02_PowerFactor_Avg', voltage: 'U15_GW02_Voltage_Avg', metername: 'Ring A/C (Return Fans)', deptname: 'Ring A/C', MCS: '1', installedLoad: '207.0', info: 'Dust Collector Fans + Rotary Air filter '
    },

    {
      energy: 'U16_GW02_Del_ActiveEnergy', power: 'U16_GW02_ActivePower_Total', powerFactor: 'U16_GW02_PowerFactor_Avg', voltage: 'U16_GW02_Voltage_Avg', metername: 'PF Panel LT#01', deptname: 'PF Panels', MCS: '1', installedLoad: '600'
    },
    ...
    {
      energy: 'U17_GW02_Del_ActiveEnergy', power: 'U17_GW02_ActivePower_Total', powerFactor: 'U17_GW02_PowerFactor_Avg', voltage: 'U17_GW02_Voltage_Avg', metername: 'Card 8-14 + Bailing Press - 01', deptname: 'Card', MCS: '8', installedLoad: '160.3', info: '07*21.9kW + 01*7kW'
    },
    ...
    { energy: 'U20_GW02_Del_ActiveEnergy', power: 'U20_GW02_ActivePower_Total', powerFactor: 'U20_GW02_PowerFactor_Avg', voltage: 'U20_GW02_Voltage_Avg', metername: 'Winding A/C', deptname: 'Winding A/C', MCS: '1', installedLoad: '113.5', info: '100.5kW + 7.5kW' },
  ...
  private unit5Lt2Meters = [
    ...
    {
      energy: 'U18_GW03_Del_ActiveEnergy', power: 'U18_GW03_ActivePower_Total', powerFactor: 'U18_GW03_PowerFactor_Avg', voltage: 'U18_GW03_Voltage_Avg', metername: 'PF Panel LT#02', deptname: 'PF Panels', MCS: '1', installedLoad: '600'
    },
  ];
  ...
  )
  {
    ...
    console.log('this is PDB1CD1',PDB1CD1_U4)
